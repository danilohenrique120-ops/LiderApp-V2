...
const Dashboard: React.FC<DashboardProps> = ({ 
    ...
    // Estilo padrão para Tooltips dos gráficos para garantir legibilidade (Texto Escuro em Fundo Claro)
    const tooltipStyle = {
    ...
    const gapTrend = [
        { v: 40 }, { v: 35 }, { v: 50 }, { v: 45 }, { v: 60 }, { v: 55 }, { v: totalGaps }
    ];

    return (
        <div id="print-dashboard" className="animate-fade bg-[#0F172A] min-h-screen p-0 selection:bg-blue-500/30">
            <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6 px-2">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></div>
                        <span className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em]">Sistema Líder</span>
                    </div>
                    <h2 className="text-4xl font-black text-white tracking-tighter uppercase leading-none">Cockpit Operacional</h2>
                </div>
                <button 
                    onClick={() => exportToPDF('print-dashboard', 'Dashboard-Lider')} 
                ...
                >
                    <Download size={16} /> Relatório Analítico
                </button>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Alerta de Skill</h3>
                        ...
                        <div className="flex items-baseline gap-4 mb-6">
                            ...
                            <div className="space-y-1">
                                ...
                                <span className="text-xs font-medium text-slate-400 uppercase tracking-widest block">Treinamentos Críticos</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-auto flex items-center justify-between">
                            ...
                            <div className="flex -space-x-3">
                                {[1,2,3].map(i => (
                                    <div key={i} className="w-10 h-10 rounded-full border-2 border-[#1E293B] bg-slate-700 flex items-center justify-center text-[10px] font-black text-slate-400 shadow-sm">
                                        {i === 3 ? '+8' : 'OP'}
                                    </div>
                                ))}
                            </div>
                ...
                <div className="dashboard-card p-8 flex flex-col group">
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-slate-400 font-medium leading-relaxed">Status de homologação dos procedimentos operacionais.</p>
                    </div>
                    <button 
                ...
                <div className="dashboard-card p-8 flex flex-col group">
                    <div className="flex-1">
                        ...
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Operadores Ativos</p>
                    </div>
                    <button 
                ...
                <div className="dashboard-card p-8 flex flex-col group">
                    <div className="flex-1">
                        ...
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Execução de Planos</p>
                    </div>
                    <button 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
                ...
                {/* MATRIZ DE AÇÃO IMEDIATA */}
                <div className="lg:col-span-2 dashboard-card p-10 flex flex-col">
                    <div className="flex items-center justify-between mb-10">
                        <div>
                            <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Live Watch</h3>
                            <p className="text-xl font-black text-white tracking-tight">Vulnerabilidades de Campo</p>
                        </div>
                    ...
                    <div className="flex-1 space-y-4">
                        {priorityAlerts.length > 0 ? (
                            ...
                            <EmptyState 
                                ...
                                description="Nenhum desvio crítico registrado nas últimas 24h."
                                primaryActionLabel="Ver Time Completo"
                ...
                {/* PIE CHART: MATURIDADE TÉCNICA */}
                <div className="dashboard-card p-10 flex flex-col items-center">
                    <div className="text-center mb-10">
                        <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Asset Maturity</h3>
                        <p className="text-xl font-black text-white tracking-tight">Mix de Níveis</p>
                    </div>
