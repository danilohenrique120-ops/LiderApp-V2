                                ...
                                <table className="w-full text-left border-collapse">
                                    ...
                                    <tbody className="divide-y divide-slate-700/50">
                                        {[
                                            ...
                                            {
                                                name: "Análise de Causa (Ishikawa / 5 Porquês)",
                                                cost: "5 Créditos",
                                                desc: "Descobre a raiz do problema estrutural ou sistêmico na operação.",
                                                icon: Search,
                                                color: "text-blue-500"
                                            },
                                            {
                                                ...
                                                cost: "8 Créditos",
                                                desc: "Monta o plano de evolução e desenvolvimento para o seu funcionário.",
                                                icon: Target,
                                                color: "text-indigo-500"
                                            }
                                        ].map((item, i) => (
