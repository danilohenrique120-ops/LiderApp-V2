...
import { Operator, SkillConfig, PDI, Meeting, Procedure, TrainingRecord, ProductionEntry, HumanErrorInvestigation } from './types';
...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Fix: Removed .default from firebase type reference to match the namespace structure
    ...
    const menu = [
        ...
        { id: 'human-error', label: 'Erro Humano', icon: ShieldAlert },
    ];
